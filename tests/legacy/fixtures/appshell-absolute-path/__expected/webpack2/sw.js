...
var idbKeyval = __webpack_require__(0);
...
function WebpackServiceWorker(params, helpers) {
  ...
  function init() {
    return getMetadata().then(function (_ref) {
      var finalAssets = _ref.assets;
      var finalHashesMap = _ref.hashesMap;
      var finalExternals = _ref.externals;
  ...
  self.addEventListener('install', function (event) {
    ...
    if (strategy === 'changed') {
      installing = init().then(function () {
        return cacheChanged('main');
      });
    } else {
      installing = init().then(function () {
        return cacheAssets('main');
      });
    }
  ...
  function mapAssets(_ref2) {
    ...
    var finalHashesMap = Object.entries(hashesMap).reduce(function (result, _ref4) {
  ...
  function addAllNormalized(cache, requests, options) {
    ...
    return Promise.all(requests.map(function (request) {
      ...
      return deleting.then(function () {
        var addAll = responses.map(function (_ref5, i) {
